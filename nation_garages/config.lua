...
config.imgDir = "http://191.101.131.220/images/" -- url ou diretorio das imagens
----------------------------------------------
----------- LISTA DE VEÍCULOS ----------------
----------------------------------------------
config.vehList = {
...
config.garages = {
  ...
  vehicles = {
	...
	vehicles = {
	  ...
	  [8] = { type = 'service', coords = vec3(-569.55, -925.95, 36.833), perm = 'weazel.permissao',  -- // WEAZEL  (HELI)
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [9] = { type = 'service', coords = vec3(-537.10,-886.54, 25.208), perm = 'weazel.permissao', --  // Weazel (CARRO)
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [10] = { type = 'service', coords = vec3(-341.19,-1567.68,25.22), perm = nil, -- //
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [12] = { type = 'service', coords = vec3(1200.41,-1276.48, 35.22), perm = nil,  -- NN
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [13] = { type = 'service', coords = vec3(-1032.1600,-2729.84,13.7566), perm = nil, -- BIKES //
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [14] = { type = 'public', coords = vec3(55.55,-876.43,30.66), perm = nil, -- GARAGEM 1
	vehiclePositions = {
...
-- 	  [15] = { type = 'public', coords = vec3(596.4,90.65,93.12), perm = nil,  -- GARAGEM 2
-- 	vehiclePositions = {
...
-- 	},
--   },
	  [15] = { type = 'public', coords = vec3(214.02,-808.44,31.01), perm = nil, --GARAGEM 7 (atras da praça) //
	vehiclePositions = {
...
-- 	  [21] = { type = 'public', coords = vec3(-348.88,-874.02,31.31), perm = nil, -- GARAGEM 8 //
-- 	vehiclePositions = {
-- 	  [1] = { vec3(-343.73,-875.45,30.22), h = 168.42 },
-- 	  [2] = { vec3(-339.98, -877.39, 31.08), h = 168.42 },
-- 	  [3] = { vec3(-336.54, -878.5, 31.08), h = 168.42 },
-- 	},
--   },
-- 	  [22] = { type = 'public', coords = vec3(157.26, -124.67, 54.83), perm = nil,  -- GARAGEM 9  //
-- 	vehiclePositions = {
...
-- 	},
--   },	
-- 	  [23] = { type = 'public', coords = vec3(361.9,297.81,103.88), perm = nil, -- GARAGEM 10  //
-- 	vehiclePositions = {
...
-- 	},
--   },
-- 	  [24] = { type = 'public', coords = vec3(-773.34,5598.15,33.6), perm = nil, -- GARAGEM 11(RESPAW PALETO) //
-- 	vehiclePositions = {
-- 	  [1] = { vec3(-772.82,5578.48,32.64), h = 89.01 },
-- 	  [2] = { vec3(-772.52, 5572.67, 33.49), h = 89.01 }, 
-- 	},
--   },
-- 	  [25] = { type = 'public', coords = vec3(323.5,-203.07,54.08), perm = nil, -- GARAGEM 12 //
-- 	vehiclePositions = {
...
-- 	},
--   },
-- 	  [26] = { type = 'public', coords = vec3(317.25,2623.14,44.46), perm = nil, -- GARAGEM 13 //
-- 	vehiclePositions = {
-- 	  [1] = { vec3(334.52,2623.09,44.49), h = 20.0 },
-- 	},
--   },
-- 	  [27] = { type = 'public', coords = vec3(1156.9,-453.73,66.98), perm = nil, -- GARAGEM 14 //
-- 	vehiclePositions = {
...
-- 	},
--   },
-- 	  [28] = { type = 'public', coords = vec3(-102.21,6345.18,31.57), perm = nil, -- GARAGEM 15 //
-- 	vehiclePositions = {
...
-- 	},
--   },
	  [16] = { type = 'service', coords = vec3(-1605.19,-1164.37,1.28), perm = nil, --EMBARCAÇÕES --PRAIA
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [17] = { type = 'service', coords = vec3(-1522.68,1494.92,111.58), perm = nil, --EMBARCAÇÕES
	vehiclePositions = {
	  ...
	  [18] = { type = 'service', coords = vec3(1337.36,4269.71,31.5), perm = nil, --EMBARCAÇÕES - PESCA
	  vehiclePositions = {
	  ...
	  [19] = { type = 'service', coords = vec3(-192.32,791.54,198.1), perm = nil,  --EMBARCAÇÕES
	vehiclePositions = {
	...
	vehicles = {
	  ...
	  [20] = { type = 'public', coords = vec3(101.1,-1073.71,29.38), perm = nil, --Garagem perto da praça //
	vehiclePositions = {
...
-- 	  [21] = { type = 'public', coords = vec3(1539.67,3780.9,34.06), perm = nil, --Garagem do norte  //
-- 	vehiclePositions = {
-- 	  [1] = { vec3(1543.06,3780.08,33.64), h = 27.98 },
-- 	  [2] = { vec3(1547.43, 3780.89, 34.07), h = 27.98 },
-- 	},
--   },
	  [21] = { type = 'service', coords = vec3(2832.27, 2797.7, 57.46), perm = nil, --Garagem do norte  //
	vehiclePositions = {
	...
	[22] = { type = 'service', coords = vec3(448.42, 6462.58, 28.99), perm = nil, -- Garagem Graos  //
	vehiclePositions = {
	...
	[23] = { type = 'service', coords = vec3(53.44, 114.78, 79.2), perm = nil, --Garagem do norte  //
	vehiclePositions = {
	...
	[24] = { type = 'service', coords = vec3(846.66, -961.26, 26.53), perm = 'mecanico.permissao', -- Garagem Mecanica para os mecanicos  //
	vehiclePositions = {
		[1] = { vec3(854.21, -958.74, 26.37), h = 120 }, 
...
-- },
-- 	[26] = { type = 'public', coords = vec3(887.58, -861.9, 26.12), perm = nil, -- Garagem Mecanica publica//
-- 	vehiclePositions = {
